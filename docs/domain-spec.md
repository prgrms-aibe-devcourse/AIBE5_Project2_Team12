...
이 문서는 2026-04-10 기준 `ERDCloud` 초안을 기준으로 `member`, `resume`, `file`, `skill`, `proposal`, `proposal_position`, `position`, `matching` 도메인을 다시 정렬한 명세다.
...
### 9.2 proposal_position 상세 필드 확장
